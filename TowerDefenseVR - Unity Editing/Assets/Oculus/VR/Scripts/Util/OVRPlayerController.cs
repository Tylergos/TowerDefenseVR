...
public class OVRPlayerController : MonoBehaviour
{
	...
	void Update()
	{
        ...
        Gun.transform.localPosition = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch);
        Gun.transform.rotation = OVRInput.GetLocalControllerRotation(OVRInput.Controller.RTouch);
    }
